...
Socrate s'oppose aux sophistes, aux marchands de science. Il prétend qu'il n'y a pas d'enseignement ; qu'apprendre n'est autre chose que se ressouvenir.

## Le carré deux fois plus grand

Discussion sur le carré deux fois plus grand dans le *Ménon*.

Résumé du *Ménon*. Ménon demande à Socrate de lui prouver ce que ce dernier avance, à savoir qu'il n'y a pas d'enseignement.

Socrate propose une **expérience** qui consiste à proposer un problème de géométrie à un serviteur. Le problème consiste, à partir d'un carré donné, à construire un carré deux fois plus grand.
...
À la fin de la discussion il se rend compte que c'est la diagonale du carré qui engendre l'espace double. Il le **sait** parce qu'il l'a **vu**, non pas avec les yeux, mais au moyen d'un raisonnement.

### Lecture d'un fragment du *Ménon*
...
L'état dans lequel se trouve à présent le serviteur est moins agréable, mais il vaut mieux. Socrate ne lui a fait aucun tort, mais lui a plutôt rendu service. Socrate a mis le serviteur dans l'embarras. Il se compare lui-même à la torpille, ce poisson qui engourdit celui qui le touche. Socrate a rendu service au serviteur. Maintenant que ce dernier a conscience de ne pas connaître la solution, il n'ira pas se ridiculiser en prétendant qu'il la connaît. En outre, il est maintenant disposé à chercher : il **aimerait savoir** quelle est la longueur du côté de ce carré.
